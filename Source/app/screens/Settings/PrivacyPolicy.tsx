  ...
  return (
    <ScrollView style={{ padding: 20, flex: 1 }}>
      <Text style={{ marginBottom: 20 }}>
        Privacy Policy {"\n"}
        {"\n"}Asiern built the Speedrun.com app as an Open Source app. This
        SERVICE is provided by Asiern at no cost and is intended for use as is.
        ...
        Conditions, which is accessible at this link unless otherwise defined in
        ...
        {"\n"}
        Security I value your trust in providing us your Personal Information,
        ...
        {"\n"}
        Links to Other Sites This Service may contain links to other sites. If
        you click on a third-party link, you will be directed to that site. Note
        ...
        Policy on this page. This policy is effective as of 2020-08-19 {"\n"}
        {"\n"}
        Contact Us If you have any questions or suggestions about my Privacy
        Policy, do not hesitate to contact me at asiern.dev@gmail.com. This
